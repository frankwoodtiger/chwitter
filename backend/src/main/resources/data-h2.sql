...
INSERT INTO USERS_ROLES (USER_ID, ROLE_ID)
    VALUES
        ...
        (SELECT ID FROM USER WHERE USERNAME = 'chi', SELECT ID FROM ROLE WHERE NAME = 'ROLE_ADMIN'),
        (SELECT ID FROM USER WHERE USERNAME = 'chi', SELECT ID FROM ROLE WHERE NAME = 'ROLE_USER'),
        (SELECT ID FROM USER WHERE USERNAME = 'terryleong', SELECT ID FROM ROLE WHERE NAME = 'ROLE_USER'),
