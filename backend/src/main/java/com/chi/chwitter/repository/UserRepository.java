...
import com.chi.chwitter.entity.Role;
...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select u from User u where " +
            ...
            ":userRole member of u.roles and " +
    ...
    Set<PotentialFollower> findPotentialFollowersByKeyword(
            @Param("currentUser") User currentUser, @Param("userRole") Role userRole, @Param("keyword") String keyword);
}
